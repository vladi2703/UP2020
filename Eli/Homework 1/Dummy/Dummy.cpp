...
int main()
{
    ...
    int snake[50];
    int pointsForward = 0, countSteps = 0;
    for (int i = 0; i < 50; i++)
    {
        switch (i)
        {
      ...
      ////и прибавяме 1 (за да станат от 1 до 6)
       /* int random; 
        ...
        if (countSteps % 2 == 1)
        {
            ...
            countSteps++;
            cout << "Player1 is on " << position1 + 1 << " position" << endl;
            if (position1 + 1 == 50)
            {
                break;
            }
        ...
        else 
        {
            ...
            cout << "Player2 is on " << position2 + 1 << " position" << endl;
            random = 0;
            pointsForward = 0;
        }
    ...
    if (position1 == 49)
    {
        cout << "Congratulations Player1 you won in " << countSteps << " turns";
    }
    else if (position2 == 49)
    {
        cout << "Congratulations Player2 you won in " << countSteps << " turns";
    }
